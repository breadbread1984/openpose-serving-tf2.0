...
class OpenPose(object):
  ...
  def predict(self, img):
    ...
    for inputs, pad in processed:
      ...
      paf, heatmap = np.array(json.loads(json_response.text)["predictions"][0]['Mconv7_stage6_L1']), np.array(json.loads(json_response.text)["predictions"][0]['Mconv7_stage6_L2']);
